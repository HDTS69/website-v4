...
export function Hero() {
  ...
  return (
    <div className="relative min-h-[100dvh] flex flex-col bg-black opacity-0 animate-fade-in animation-delay-200 overflow-x-hidden overflow-y-auto pb-24 pt-32 touch-auto">
      ...
      >
        <div className="flex flex-col items-center min-h-[calc(100vh-240px)] justify-center mt-8">
          {/* Hero Text */}
